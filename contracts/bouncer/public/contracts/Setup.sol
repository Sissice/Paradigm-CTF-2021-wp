...
interface WETH93 is ERC20Like {
    function deposit() external payable;
}

contract bouncerSetup {
    address constant ETH = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
    WETH93 constant weth = WETH93(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
    ...
    function bal() public view returns (uint256) {
        return address(bouncer).balance;
    }
}
